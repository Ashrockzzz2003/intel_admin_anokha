                    ...
                    <div className={(windowWidth < 768) ? "block w-fit ml-auto mr-auto" : "flex flex-row"}>
                        ...
                        <span className={`md:flex md:flex-row md:space-y-0 md:pt-0 flex flex-col space-y-3 pt-2 pb-3 md:pb-0 items-center align-middle ${isMenuOpen && windowWidth < 768 ? 'flex' : 'hidden'}`}>
                            ...
                            {isLoggedIn ? (
                                ...
                                <li className="text-white relative cursor-pointer whitespace-nowrap"><Link className="text-white px-2 py-4 m-2 hover:bg-white hover:px-4 hover:py-3 hover:rounded-xl hover:text-black hover:shadow-lg cursor-pointer" href="/intel-admin/login">Login</Link></li>
                            )}
                        </span>
                    </div>
                </ul>
