...
export default function RoundOneSubmissionsScreen() {
            ...
            switch (response.status) {
                case 200:
                    response.json().then((data) => {
                        ...
                        // filter with submissions that have submission.teamStatus === '3'
                        data["submissions"] = data["submissions"].filter((submission) => {
                            return submission.teamStatus === '3';
                        });
    ...
    return <>
        ...
        <main className="h-full">
            ...
            <h1 className="mb-8 pt-8 text-2xl text-lime-50 text-center">Round Three Shortlisted Teams</h1>
                ...
                <table className="text-black ml-auto mr-auto border-collapse mb-16">
                    <thead className="">
                        <tr>
                            ...
                            <th className="text-center p-2 bg-black text-white rounded-tr-xl">GitHub</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            return (
                                <tr key={index} className="text-sm">
                                    ...
                                    <td className="border p-1 text-center bg-white text-sm">
                                        {submission.theme === '0' ? "GenAI" : submission.theme === '1' ? "IOT" : submission.theme === '2' ? "Autonomous Vehicles" : submission.theme === '3' ? "Healthcare" : submission.theme === '4' ? "CyberSecurity" : "OpenEnded"}
                                    </td>
